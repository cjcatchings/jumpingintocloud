...
export default function CloudFrontSummary(){
    ...
    return (
        <TextSubSection
            ...
            <p className="pt-2">With my content stored in an S3 bucket, I created a CloudFront distribution and specified my bucket as the origin.  CloudFront 
            ...
            <p className="pt-2">In order to create a Route 53 Alias record for this distribution (to direct traffic from www.jumpingintocloud.com to it), I needed 
            ...
            <p className="pt-2">The last step was to add an Alias record to the hosted zone for this domain in Route 53.  I specified the www sub-domain and selected 
