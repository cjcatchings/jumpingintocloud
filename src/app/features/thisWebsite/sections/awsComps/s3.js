...
export default function S3Summary() {
    ...
    return (
        <TextSubSection
            ...
            <p className="pt-2 mr-2">I created a
            ...
            <p className="pt-2 mr-2">I created an S3 bucket exclusively to hold the generated files for my NextJS app.  S3 buckets can
            ...
            <p className="pt-2 mr-2">Origin Access Control (OAC) allows you to restrict access to website content hosted on S3 to the CloudFront distribution hosting the content.
                This can be beneficial for performance and cost reasons:</p>
                <ol className="pt-2 list-decimal">
                    <li className="ml-6 mr-2">CloudFront hosts the content of your S3 bucket in edge locations across the globe, delivering the content faster to
                        end-users from a location geographically closest to them.</li>
                    <li className="ml-6 mr-2">Delivery of data from CloudFront ($0.085/GB with the first 1TB each month free) is less expensive than from S3
